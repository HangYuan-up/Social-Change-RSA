...
##以老年人孤独感为例
CLHLSdata <- read_excel("H:/1_中大工作/10.文化变迁/7.文章修改/1.老年人孤独感变迁.xlsx")
...
##以老年人心理健康为例
CLHLSdata <- read_excel("H:/1_中大工作/10.文化变迁/7.文章修改/2.老年人心理健康变迁.xlsx")
...
##以北京老年人认知功能为例
CLHLSdata <- read_excel("H:/1_中大工作/10.文化变迁/7.文章修改/3.北京老年人认知功能变迁.xlsx")
...
##以老年人心理健康为例
CLHLSdata <- read_excel("H:/1_中大工作/10.文化变迁/7.文章修改/4.跨地区老年人心理健康变迁.xlsx")
...
##以1998年老年人心理健康为例
CLHLSdata <- read_excel("H:/1_中大工作/10.文化变迁/7.文章修改/5.1998年跨地区老年人心理健康变迁.xlsx")
CLHLSdata <- as.data.frame(CLHLSdata)
...
#模型构建：概念模型的表征相似性矩阵
##以中国“五年计划”政策为例
CLHLSdata <- read_excel("H:/1_中大工作/10.文化变迁/7.文章修改/6.概念模型.xlsx")
CLHLSdata <- as.data.frame(CLHLSdata)
